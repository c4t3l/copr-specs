# Generated from tty-cursor-0.7.1.gem by gem2rpm -*- rpm-spec -*-
%global gem_name tty-cursor
...
%changelog
* Sat Sep 17 2022 Robby Callicotte <rcallicotte@fedoraproject.org> - 0.7.1-1
- Initial package
