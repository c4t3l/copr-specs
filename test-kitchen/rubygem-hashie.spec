# Generated from hashie-5.0.0.gem by gem2rpm -*- rpm-spec -*-
...
# git archive -v -o hashie-5.0.0-spec.tar.gz v5.0.0 spec/
...
%changelog
* Sat Sep 24 2022 Robby Callicotte <rcallicotte@fedoraproject.org> - 5.0.0-2
- Added changelog back to specfile
- Moved UPGRADING.md to doc sub-package

* Sun Sep 11 2022 Robby Callicotte <rcallicotte@fedoraproject.org> - 5.0.0-1
- Unretired package
  Resolves: rhbz#2127693
